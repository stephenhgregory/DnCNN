...
def main(root_dir=(os.getcwd() + '/data/CoregisteredImages')):
    create_train_test_val_dirs(root_dir)
    populate_train_test_val_dirs(root_dir)
...
def populate_train_test_val_dirs(root_dir=(os.getcwd()), val_ratio=0.15, test_ratio=0.05):
    """
